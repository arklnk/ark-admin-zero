...
func AvatarUrl() string {
	url := fmt.Sprintf(
		"https://getavataaars.com/?accessoriesType=%s&avatarStyle=%s&clotheColor=%s&clotheType=%s&eyeType=%s&eyebrowType=%s&facialHairColor=%s&facialHairType=%s&hairColor=%s&hatColor=%s&mouthType=%s&skinColor=%s&topType=%s",
		accessoriesType(),
		avatarStyle(),
		clotheColor(),
		clotheType(),
...
func accessoriesType() string {
	...
	return accessoriesType[rand.Intn(6)]
}
...
func facialHairType() string {
	...
	return facialHairType[rand.Intn(5)]
}
...
func facialHairColor() string {
	...
	return facialHairColor[rand.Intn(7)]
}
...
func clotheColor() string {
	...
	return clotheColor[rand.Intn(14)]
}
...
func eyebrowType() string {
	...
	return eyebrowType[rand.Intn(11)]
}
